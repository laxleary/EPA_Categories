...
<graphml xmlns="http://graphml.graphdrawing.org/xmlns" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://graphml.graphdrawing.org/xmlns http://graphml.graphdrawing.org/xmlns/1.0/graphml.xsd"><key id="d0" for="node" attr.name="label" attr.type="string"/>
<graph edgedefault="undirected"><node id="1">
  <data key="d0">Acid Chlorides</data>
</node>
<node id="3">
  <data key="d0">Acrylates/Methacrylates (Acute toxicity)</data>
</node>
<node id="4">
  <data key="d0">Aldehydes (Acute toxicity)</data>
</node>
<node id="5">
  <data key="d0">Aliphatic Amines</data>
</node>
<node id="6">
  <data key="d0">Aluminum Compounds</data>
</node>
<node id="7">
  <data key="d0">Anilines (Acute toxicity)</data>
</node>
<node id="8">
  <data key="d0">Azides (Acute toxicity)</data>
</node>
<node id="9">
  <data key="d0">Benzotriazoles (Acute toxicity)</data>
</node>
<node id="10">
  <data key="d0">Benzotriazole-hindered phenols</data>
</node>
<node id="11">
...
<node id="17">
  <data key="d0">Hydrazines and Related Compounds</data>
</node>
<node id="18">
  <data key="d0">Hindered Amines</data>
</node>
<node id="19">
  <data key="d0">Imides (Acute toxicity)</data>
</node>
<node id="21">
  <data key="d0">Neutral Organics</data>
</node>
<node id="23">
  <data key="d0">Nonionic Surfactants</data>
</node>
<node id="25">
  <data key="d0">Peroxides</data>
</node>
<node id="26">
  <data key="d0">Phenolphthaleins</data>
</node>
<node id="27">
  <data key="d0">Phenols (Acute toxicity)</data>
</node>
<node id="29">
  <data key="d0">Phosphinate Esters (Acute toxicity)</data>
</node>
<node id="31">
  <data key="d0">Thiols (Acute toxicity)</data>
</node>
<node id="32">
  <data key="d0">Substituted Triazines (Acute toxicity)</data>
</node>
<node id="33">
  <data key="d0">Triarylmethane Pigments/Dyes with Non-solubilizing Groups</data>
</node>
<node id="34">
  <data key="d0">Vinyl Esters (Acute toxicity)</data>
</node>
<node id="35">
  <data key="d0">Vinyl Sulfones</data>
</node>
<node id="37">
  <data key="d0">Anhydrides, Carboxylic acid</data>
</node>
<node id="39">
  <data key="d0">Diisocyanates</data>
</node>
<node id="40">
  <data key="d0">Alkoxysilanes</data>
</node>
<node id="41">
...
<node id="49">
  <data key="d0">Acrylates/Methacrylates (Chronic toxicity)</data>
</node>
<node id="50">
  <data key="d0">Aldehydes (Chronic toxicity)</data>
</node>
<node id="51">
  <data key="d0">Anilines (Chronic toxicity)</data>
</node>
<node id="53">
  <data key="d0">Benzotriazoles (Chronic toxicity)</data>
</node>
<node id="55">
  <data key="d0">Esters (Chronic toxicity)</data>
</node>
<node id="56">
  <data key="d0">Imides (Chronic toxicity)</data>
</node>
<node id="58">
  <data key="d0">Phenols (Chronic toxicity)</data>
</node>
<node id="61">
  <data key="d0">Substituted Triazines (Chronic toxicity)</data>
</node>
<node id="62">
  <data key="d0">Thiols (Chronic toxicity)</data>
</node>
<node id="63">
  <data key="d0">Vinyl Esters (Chronic toxicity)</data>
</node>
<node id="65">
  <data key="d0">Ethylene Glycol Ethers</data>
</node>
